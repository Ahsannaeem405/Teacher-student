...
<div class="container-fluid" style="margin-bottom: 50px;">
    ...
    <div class="row">
        <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="col-12">
                <div class="card mt-5 ">
                    <img src="{{url('/images/teacher-pic1.png')}}" width="260" style="background-size: cover" alt="Image" />
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="col-12">
                <div class="card mt-5 ">
                    <img src="{{url('/images/teacher-pic2.png')}}" width="260" style="background-size: cover" alt="Image" />
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4">
            <div class="col-12">
                <div class="card mt-5 ">
                    <img src="{{url('/images/teacher-pic3.png')}}" width="260" style="background-size: cover" alt="Image" />
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
